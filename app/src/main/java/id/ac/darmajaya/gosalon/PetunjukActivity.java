...
import id.ac.darmajaya.gosalon.utils.Tools;

public class PetunjukActivity extends AppCompatActivity {

    int[] datalayout = new int[]{R.string.pemesanan};
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = layoutInflater.inflate(R.layout.petunjuk_item, container, false);
